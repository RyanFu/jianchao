...
//		        layout_btn.setVisibility(View.GONE);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tz_inxest_btn = (LinearLayout) findViewById(R.id.tz_inxest_btn);
		tz_inxest_btn.setOnClickListener(this);
		tz_inxest_btn.setEnabled(false);

		tz_lend_btn = (LinearLayout) findViewById(R.id.tz_lend_btn);
		tz_lend_btn.setOnClickListener(this);
		tz_lend_btn.setEnabled(false);

		btn_tz = (TextView) findViewById(R.id.btn_tz);
