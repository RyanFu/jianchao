...
public class PersonInfoUpload extends BaseActivity implements OnClickListener {
						...
						try {
							...
							if (statusCode == 200) {
								...
								if (json.getInt("status") == 1) {
									...
									SystenmApi.showCommonErrorDialog(PersonInfoUpload.this, json.getInt("status"),message);
								}
							} else {
