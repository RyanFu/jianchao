...
//                    doHttpHK(v, adapter.getItem(position).getSort_order());
//                    LendManagerRepaymentDialog(v, "对第" + adapter.getItem(position).getSort_order() + "期进行还款?");
...
//            viewHolder.tv_hk.setTag(position);
//            viewHolder.tv_hk.setOnClickListener(payBackOnClickListener);
...
//    private OnClickListener payBackOnClickListener = new OnClickListener() {
//        @Override
//        public void onClick(View view) {
//             int payBackIndex = (Integer)view.getTag();
////            String dd=adapter.getItem(payBackIndex).getSort_order();
//            LendManagerRepaymentDialog(view, "对第" + adapter.getItem(payBackIndex).getSort_order() + "期进行还款?");
//
//        }
//    };
...
//    private void doHttpHK(final View v) {
