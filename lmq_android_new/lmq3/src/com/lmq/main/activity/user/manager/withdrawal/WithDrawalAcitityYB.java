                        ...
                        try {
                            ...
                            if (statusCode == 200) {
                                if (json.getInt("status") == 1) {
                                    ...
                                    tx_show2.setText("2.次日到账："+withdrawfee+"元/笔，即时到账：提现金额"+withdrawrates*100 +"笔，最低不能低于"+withdrawmin+"" +
                                            "元/笔，如果提现金额"+withdrawrates*100 +withdrawmin+"元，手续费则按"+withdrawmin+"元计算。");
