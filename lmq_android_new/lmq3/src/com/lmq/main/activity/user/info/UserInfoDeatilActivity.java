...
public class UserInfoDeatilActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if(Default.IS_YB){
			...
			findViewById(R.id.yb_info).setVisibility(View.VISIBLE);
            ...
            findViewById(R.id.yb_info).setVisibility(View.GONE);
    ...
    public void initView() {
        ...
        findViewById(R.id.yb_info).setOnClickListener(this);
...
//                        startActivity(intent2);
            ...
            case R.id.yb_info:
                ...
                if(!Default.has_Ybbind){
                    if (real_status != 1) {
                        showCustomToast("请先通过实名认证");
//					startActivity(new Intent(UserInfoDeatilActivity.this, OpenThirdActivity.class));
                    }else{
